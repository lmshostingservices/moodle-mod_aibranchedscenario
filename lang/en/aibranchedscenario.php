...
$string['completionfinish'] = 'Learner must finish every scenario in the ladder';
$string['completionminscore'] = 'Minimum decision quality';
$string['completionminscore_help'] = 'A percentage between 0 and 100, applied to each scenario in the ladder. It is also what unlocks the next one: a learner opens the intermediate scenario by reaching this on the foundation one. Leave it at 0 to accept any finished attempt.';
$string['completiondetail:finish'] = 'Finish every scenario in the ladder';
$string['completiondetail:finishwithscore'] = 'Pass every scenario in the ladder with a decision quality of at least {$a}%';
...
$string['tier'] = 'Scenario';
$string['tier:foundation'] = 'Foundation';
$string['tier:intermediate'] = 'Intermediate';
$string['tier:advanced'] = 'Advanced';
$string['tier:foundationblurb'] = 'Start here. The situation is clear and there is time to think.';
$string['tier:intermediateblurb'] = 'The same ideas under pressure, with somebody who disagrees.';
$string['tier:advancedblurb'] = 'Nothing is signposted. You are the most senior person who has seen it.';
$string['ladder:title'] = 'Three scenarios, one after another';
$string['ladder:lead'] = 'Each one tests the same ideas in a harder situation. Pass one to open the next.';
$string['ladder:locked'] = 'Opens when you pass {$a}';
$string['ladder:lockedfirst'] = 'Not available yet';
$string['ladder:notwritten'] = 'Not written yet';
$string['ladder:passed'] = 'Passed';
$string['ladder:best'] = 'Your best: {$a}%';
$string['ladder:start'] = 'Start';
$string['ladder:again'] = 'Try again';
$string['ladder:continue'] = 'Continue';
$string['ladder:progress'] = 'Scenario {$a->done} of {$a->total} passed';
$string['ladder:allpassed'] = 'You have passed all three.';
$string['ladder:back'] = '← All scenarios';
$string['ladder:whichscenario'] = 'Which scenario';
$string['ladder:live'] = 'Live';
$string['ladder:draftonly'] = 'Draft';
$string['ladder:empty'] = 'Not started';
$string['generateladder'] = 'Generate all three scenarios';
$string['generateone'] = 'Generate the {$a} one only';
$string['generateonehint'] = 'Rewrites this scenario and leaves the other two alone.';
$string['confirmgenerate:ladder'] = 'This writes all three scenarios — foundation, intermediate and advanced — from the material you have described. They test the same ideas at rising difficulty.';
$string['confirmgenerate:replacesladder'] = 'One or more of the three already has a draft. Generating replaces it. You can undo the last change to a scenario from its own page.';
$string['work:writingladder'] = 'Writing three scenarios';
$string['generationladderqueued'] = 'Three scenarios queued';
$string['generationladderprogress'] = '{$a->done} of {$a->total} scenarios written';
...
$string['field:complexityfixed'] = 'Set by which scenario you are writing. This one is the {$a} scenario, so it is written at {$a} complexity.';
...
$string['error:tierlocked'] = 'This scenario is not open yet. Pass the one before it first.';
$string['error:tierunknown'] = 'That scenario does not exist in this activity.';
