...
$string['takeaways'] = 'Worth taking with you';
$string['debriefend'] = 'That is the debrief';
...
$string['error:principleneedsexample'] = 'The principle "{$a}" has no example. Every principle needs one: a learner remembers the words they can use, not the rule.';
$string['error:principleneedspitfall'] = 'The principle "{$a}" has no pitfall. Every principle needs one: the thing that sounds reasonable and is not is what a learner needs warning about.';
