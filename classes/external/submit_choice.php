...
class submit_choice extends external_api {
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'consequenceparas' => helper::paragraphs_structure('Consequence as escaped paragraphs'),
            'feedback'        => new external_value(PARAM_TEXT, 'Instructional feedback'),
            'feedbackparas'    => helper::paragraphs_structure('Feedback as escaped paragraphs'),
